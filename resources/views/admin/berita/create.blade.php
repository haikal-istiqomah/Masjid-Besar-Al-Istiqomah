                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="judul" id="judul" value="{{ old('judul') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="isi" id="isi" rows="10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required>{{ old('isi') }}</textarea>
                        </div>
                        ...
                        {{-- DIV UNTUK PRATINJAU GAMBAR --}}
                        <div class="mb-4">
                            <img id="image-preview" src="#" alt="Pratinjau Gambar" class="hidden h-48 w-auto rounded-md mt-2"/>
                        </div>
                        
                        <div class="mb-4">
                            <label for="tanggal_publikasi" class="block text-sm font-medium">Tanggal Publikasi</label>
                            <input type="date" name="tanggal_publikasi" id="tanggal_publikasi" value="{{ old('tanggal_publikasi', now()->format('Y-m-d')) }}" class="mt-1 rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required>
                        </div>
